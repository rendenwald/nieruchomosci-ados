...
| ID | Title | Type | Priority | Status | Labels |
|----|-------|------|----------|--------|--------|
| STORY-23 | Serve `/api/v1/properties` from Redis cache (TTL 2min) | story | high | todo | change |
| STORY-24 | Invalidate relevant cache keys on new property scrape | story | high | todo | change |
